...
export const exitPopupImg = document.querySelector('.popup__btn-exit_img');
export const forms =  document.forms.add;
export const popupImgPreview = document.querySelector('.popup__img');
